...
<html>
  <head>
    <title><?php echo $meta_title ; ?></title>
        ...
        <meta charset='utf-8'> 
    <!-- Bootstrap -->
    <link href="<?php echo site_url('assets/bootstrap/css/bootstrap.css') ?>" rel="stylesheet" media="screen">
    <link href="<?php echo site_url('assets/css/style.css') ?>" rel="stylesheet" media="screen">
    <link href="<?php echo site_url('assets/css/admin.css') ?>" rel="stylesheet" media="screen">
