...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="index.html">गृह पृष्ठ</a></li>
			<li><a href="#">ड्यासवोर्ड</a></li>
		</ol>
	</div>
</div>
<!--End Breadcrumb-->
...
<div id="dashboard-header" class="row">
	<div class="col-xs-12 col-sm-4 col-md-5">
		<h3>नमस्कार, अनलाइन मुद्दा दर्तामा स्वागत छ !</h3>
	</div>
		...
		<div class="row">
			<div class="col-xs-4">
				...
				<div class="sparkline-dashboard-info">
					<!--<i class="fa fa-usd"></i>-->१० थान
					<span class="txt-primary">जम्मा दर्ता संख्या</span>
				</div>
			</div>
			<div class="col-xs-4">
				<div class="sparkline-dashboard" id="sparkline-2"></div>
				<div class="sparkline-dashboard-info">
					<!--<i class="fa fa-usd"></i-->६ थान
					<span class="txt-info">दर्ता भएका</span>
				</div>
			</div>
			<div class="col-xs-4">
				<div class="sparkline-dashboard" id="sparkline-3"></div>
				<div class="sparkline-dashboard-info">
					<!--<i class="fa fa-usd"></i>-->४ थान
					<span>दरपिठ भएका</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="dashboard_tabs" class="col-xs-12 col-sm-10">
		...
		<div id="dashboard-overview" class="row" style="visibility: visible; position: relative;">
			<div id="ow-marketplace" class="col-sm-12 col-md-6">
				...
				<h4 class="page-header">हाल सम्मको</h4>
				<table id="ticker-table" class="table m-table table-bordered table-hover table-heading">
					...
					<tbody>
						<tr>
							<td class="m-ticker"><b>१</b></td>
							<td class="m-price">डाटा ईन्ट्री गरेको</td>
							<td class="m-change"><!--<i class="fa fa-angle-up"></i>--> १०</td>
						</tr>
